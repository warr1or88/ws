	...
	for (var inst of (s.seg||[])) {
		...
		let map2D = `<div id="seg${i}map2D" data-map="map2D" class="lbl-s hide">Expand 1D FX<br>
			<div class="sel-p"><select class="sel-p" id="seg${i}mp12" onchange="setMp12(${i})">
				...
				<option value="1" ${inst.mp12==1?' selected':''}>pBar</option>
				<option value="2" ${inst.mp12==2?' selected':''}>pArc</option>
				<option value="3" ${inst.mp12==3?' selected':''}>pCorner</option>
				<option value="4" ${inst.mp12==4?' selected':''}>pRadar</option>
				<option value="5" ${inst.mp12==5?' selected':''}>sColumns</option>
				<option value="6" ${inst.mp12==6?' selected':''}>sCircle</option>
				<option value="7" ${inst.mp12==7?' selected':''}>jMap</option>
			</select></div>
		</div>`;
